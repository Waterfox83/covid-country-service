...
docker rmi waterfox83/covid-country-service:latest
...
docker push waterfox83/covid-country-service:latest

echo " ++++++++++++ Deleting old kubectl deployments  ++++++++++++ "

kubectl delete deployment covid-country-service-deployment
